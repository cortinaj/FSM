...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {seg[6]}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {seg[5]}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {seg[4]}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {seg[3]}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {seg[2]}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {seg[1]}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {seg[0]}];  # "JA9"
#set_property PACKAGE_PIN AA8  [get_ports {seg[7]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {seg[2]}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {seg[1]}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {seg[0]}];  # "JB3"
#set_property PACKAGE_PIN W8 [get_ports {an[0]}];  # "JB4"
#set_property PACKAGE_PIN V12 [get_ports {an[1]}];  # "JB7"
...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN P16 [get_ports {PB[0]}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {btnS}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {btnW}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {btnE}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {btnN}];  # "BTNU"
